...
public class SessionManager implements ISessionManager {
    ...
    public SessionValue createSession(String name){
        var sessionValue = sessionRepositoryService.save(createSessionEntityDTO(name));
        sharedCoreServices.sessionCreated(sessionValue.getEntity().getId(), ParticipantValueList.createByDTO(sessionValue.getDTO().getParticipants()));
        return sessionValue;
    }
    ...
    public void closeSession(int sessionId){
        ...
        if (optionalSessionValue.isPresent()){
            ...
            sharedCoreServices.sessionClosed(entity.getId());
        }
    }
