...
//    private final ReplyingKafkaTemplate<String, Student, Result> rtkResultB;
    ...
    @Value("${nextfeed.kafka.topics.sessionManager.sessionCreate}")
    private String sessionCreateTopic;

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public void createSession(NewSessionCreate request){
        kafkaTemplate.send(sessionCreateTopic, request);
    }
